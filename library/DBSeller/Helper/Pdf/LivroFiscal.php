...
class DBSeller_Helper_Pdf_LivroFiscal extends Fpdf2File {
   ...
   */
  public function setDadosPrefeitura(Administrativo_Model_ParametroPrefeitura $oDadosPrefeitura) {
    ...
    $this->Ln();
    $this->Ln();
    $this->Cell(0, 5, utf8_decode('Livro Fiscal Serviços Prestados Mensal'), 0, 0, 'C');
    $this->Ln(15);
  }
  ...
  public function setDadosContribuinte(Contribuinte_Model_Contribuinte $oContribuinte,
    ...
    if ($oContribuinte->getTipoEmissao() == Contribuinte_Model_Contribuinte::TIPO_EMISSAO_NOTA) {
      ...
      $aLarguraCelulas = array(57, 55, 55, 55, 55);
