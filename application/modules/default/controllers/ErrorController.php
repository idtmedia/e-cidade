  ...
  public function errorAction() {
    ...
    switch ($oErrors->type) {
      ...
      case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_NO_ACTION:
        ...
        $this->view->message = $this->translate->_('404 - A página solicitada não foi encontrada');
        break;
      ...
      default:
        ...
        $this->view->title   = $this->translate->_('Ops, encontramos um problema:');
        $this->view->message = $this->translate->_('500 - Ocorreu um erro na execução da página');
        break;
    }
