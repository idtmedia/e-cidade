...
final class Contribuinte_Model_ContribuinteEventual
  ...
  public static function getById($iCodigoContribuinte) {
    ...
    $oCgm        = Contribuinte_Lib_Model_WebService::processar('pesquisaCgmByCgm', $aParametros);
  ...
  public static function getByCpfCnpjWebService($sCpfCnpj) {
    ...
    return Contribuinte_Lib_Model_WebService::processar('pesquisaCgmByCpfCnpj', $aParametros);
  }
