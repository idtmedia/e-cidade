...
class Contribuinte_Model_Cgm {
  ...
  public function persist() {
    ...
    return Contribuinte_Lib_Model_WebService::processar('gerarCgmExterno', $aDados);
  }
  ...
  public static function getDadosCgm ($sCpfCnpj) {
    ...
    $oRetornoCgm = Contribuinte_Lib_Model_WebService::processar('pesquisaCgmByCpfCnpj',
  ...
  public static function removerCgm ($iCodigoCgm) {
    ...
    return Contribuinte_Lib_Model_WebService::processar('excluirCgm', $aDados);
  }
