...
$db_config = require RUCKUSING_WORKING_BASE . DIRECTORY_SEPARATOR . 'bin' . DIRECTORY_SEPARATOR . 'ruckusing.conf.php';
...
if (!$composer_found) {
  ...
  function loader($classname) {
    ...
    include RUCKUSING_BASE . DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR .
